        ...
        <div id="info-container" class="col-lg-6 d-flex flex-column justify-content-between">
            <div>
                ...
                <div class="technical-info-box p-3 bg-light rounded-3 mb-4">
                    <p class="mb-2"><strong><i class="bi bi-calendar3"></i> Data de Entrada:</strong> {{ \Carbon\Carbon::parse($manutencao->data_entrada)->format('d/m/Y') }}</p>
                    <p class="mb-0"><strong><i class="bi bi-person"></i> Cliente:</strong> {{ $manutencao->equipamento->cliente ?? 'Não informado' }}</p>
                </div>
            </div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div id="equipamento-info-container">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="/equipaments/{{ $manutencao->equipamento_id }}" class="btn btn-sm btn-outline-dark px-3">Ver Equipamento Completo</a>
                        </div>
                        ...
                        @if($manutencao->equipamento)
                            <div class="table-responsive">
                                <table class="table custom-table align-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="fw-semibold text-dark">{{ $manutencao->equipamento->marca }} — {{ $manutencao->equipamento->tipo }}</td>
                        ...
                        @else
                            <div class="text-center py-4 bg-light rounded-3">
                                <p class="text-muted m-0">Informações do equipamento não encontradas ou excluídas.</p>
                            </div>
                        @endif
                    </div>
